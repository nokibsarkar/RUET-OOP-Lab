...
public class Cloth_Private_3 {
    ...
    public Cloth_Private_3(String shopName,String customerName, String clothType, String tailorName, int size, int price, String dateDelivered) {
    ...
    public static void main(String args[]){
        Cloth_Private_Didi cloth1 = new Cloth_Private_Didi("John", "Shirt", "Tailor1", 10, 100, "2020-08-01");
        System.out.println(cloth1);
        Cloth_Private_Didi cloth2 = new Cloth_Private_Didi("John", "Shirt", "Tailor1", 10, 100, "2020-08-01");
        System.out.println(cloth2);
        Cloth_Private_Didi cloth3 = new Cloth_Private_Didi("John", "Shirt", "Tailor1", 10, 100, "2020-08-01");
        System.out.println(cloth3);
        Cloth_Private_Didi cloth4 = new Cloth_Private_Didi("John", "Shirt", "Tailor1", 10, 100, "2020-08-01");
        System.out.println(cloth4);
        Cloth_Private_Didi cloth5 = new Cloth_Private_Didi("John", "Shirt", "Tailor1", 10, 100, "2020-08-01");
